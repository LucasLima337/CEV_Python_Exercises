def aumentar(value=0, percent=0, money=False):
    '''
    ...
    return resp if money == False else moeda(resp)

def diminuir(value=0, percent=0, money=False):
    '''
...
def metade(value=0, money=False):
    '''
...
def resumo(value=0, up=10, down=5):
    print('')
    print('=-=' * 12)
    ...
    print(f'{up}% de aumento: \t{aumentar(value, up, True)}')
    print(f'{down}% de desconto: \t{diminuir(value, down, True)}')
    print('=-=' * 12)
